...
|---|---|---|---|
| **Amazon Tax Exemption Program (ATEP)** | Kansas 6.5% + Johnson County 1.475% + Lenexa city 1.375% = **9.35% combined** on non-grocery items ([Lenexa city rates](https://www.lenexa.com/Government/Budget-Taxes/Sales-Property-Tax)); groceries carry ~2.85% local tax. Blended: ~6.5% | $650 | $7,800 |
...
| **Business Prime rebate program (Tier 2)** | [Tiered rebate](https://business.amazon.com/en/blog/nonprofit-donor-dollar): 1%/2%/3% of Business spend by volume tier | $200 | $2,400 |
...
| **Year 2** | YouTube Shorts reaches [10M views threshold](https://support.google.com/youtube/answer/72851); X and Meta partial monetization | **$2,000 – $10,000** |
...
- We are not claiming this replaces local merchants. Every SKU carries a `preferred_vendor` field; when the grocer, pharmacist, or mechanic down the street signs the parish covenant, their vendor slug replaces Amazon's and the spread is redirected to the local economy. **Amazon is the bootstrap, not the destination.**
